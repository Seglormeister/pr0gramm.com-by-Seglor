...
// Remove span class sorter in comments
    ...
    var css = '#upload-form input[type="submit"] { position:relative; top: 420px; left: 350px; }' +
        ...
        '.item-image {width: auto !important; height: auto !important;}' +//max-width: calc(100vw - 600px) !important; 		'+highitemimage+'px '+widthitemimage+'px
...
// Observer für Seitenänderung
    ...
    function commentschange() {
        ...
        if (!is_chrome && $('.item-comments').length && !$('.item-comments').hasClass('scroll')) {
            if ($('.comments').height() > ($('.item-comments').height() - 125)) {
                ...
                if (is_chrome) {
                    $('.item-comments .second').attr('style', function (i, s) {
                        return 'top: 0px !important;' + s
                    });
                }
            }
        }
    ...
    function imagechange() {
        ...
        if ($(window).scrollTop() != posi) {
            ...
            $('html').stop();
            $('html').animate({scrollTop: posi}, 300, 'swing', function () {
                return;
            });
        }
    }
    ...
    var ssb = {
        ...
        scrollbar: function (cont_id) {
            if (cont_id == 'item-comments') {
                var cont = document.getElementsByClassName(cont_id)[0];
            }
            else if (cont_id == 'page') {
                var cont = document.getElementById(cont_id);
            }
            else if (cont_id == 'html') {
